					...
					<table class="hoverable">
						...
						<c:forEach var="item" items="${projects}">
							<tr>
								...
								<td>
									<a href="${pageContext.request.contextPath}/detail/project/${item.id}" class="btn waves-effect waves-light red lighten-2">详情</a>
									<a href="${pageContext.request.contextPath}/new/project?id=${item.id}" class="btn waves-effect waves-light red lighten-2">编辑</a>
									<a href="${pageContext.request.contextPath}/delete/project?id=${item.id}" class="btn waves-effect waves-light red lighten-2">删除</a>
								</td>
							</tr>
						</c:forEach>
						</tbody>
